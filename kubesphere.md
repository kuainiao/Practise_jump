...
docker tag registry.cn-hangzhou.aliyuncs.com/google_containers/kube-apiserver:v1.15.4             k8s.gcr.io/kube-apiserver:v1.15.4                  
docker tag registry.cn-hangzhou.aliyuncs.com/google_containers/kube-controller-manager:v1.15.4    k8s.gcr.io/kube-controller-manager:v1.15.4
docker tag registry.cn-hangzhou.aliyuncs.com/google_containers/kube-proxy:v1.15.4                 k8s.gcr.io/kube-proxy:v1.15.4             
docker tag registry.cn-hangzhou.aliyuncs.com/google_containers/kube-scheduler:v1.15.4             k8s.gcr.io/kube-scheduler:v1.15.4         
...
docker rmi registry.cn-hangzhou.aliyuncs.com/google_containers/kube-apiserver:v1.15.4          
docker rmi registry.cn-hangzhou.aliyuncs.com/google_containers/kube-controller-manager:v1.15.4 
docker rmi registry.cn-hangzhou.aliyuncs.com/google_containers/kube-proxy:v1.15.4              
docker rmi registry.cn-hangzhou.aliyuncs.com/google_containers/kube-scheduler:v1.15.4          
...
repo_gpgcheck=0
EOF
yum install -y kubernetes-cni-0.6.0 kubelet-1.15.4 kubeadm-1.15.4 kubectl-1.15.4 --disableexcludes=kubernetes --nogpgcheck

echo 1 > /proc/sys/net/bridge/bridge-nf-call-iptables
echo 1 > /proc/sys/net/ipv4/ip_forward contents
swapoff -a
sed  -i  '/swap/d'  /etc/fstab
kubeadm init --kubernetes-version=v1.15.4 --pod-network-cidr=10.96.0.10/24 --ignore-preflight-errors=NumCPU
...
mkdir -p /nfs/space2
cat >>  /etc/exports << EOF
/nfs/space2    192.168.50.0/24(rw,sync,no_root_squash)
EOF
# master 重启服务，使配置生效
...
# nodex 检验
mount -t nfs 192.168.50.31:/nfs/space2 /mnt
